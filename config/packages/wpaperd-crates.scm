;; Auto-generated from wpaperd 1.3.0 Cargo.lock — do not edit by hand.

(define-module (config packages wpaperd-crates)
...
(define rust-file-id-0.1.0
  (crate-source "file-id" "0.1.0"
...
(define rust-flexi-logger-0.31.9
  (crate-source "flexi_logger" "0.31.9"
               "1mkn3ffq1108rvya8h9y8za61v647sc65q1r90pbxzy0fw51941f"))

(define rust-format-bytes-0.3.0
  (crate-source "format-bytes" "0.3.0"
               "1zf22idlv3q99w6r71cyr84grik803hwjnhpisimv5wkxxk27528"))

(define rust-format-bytes-macros-0.4.0
  (crate-source "format-bytes-macros" "0.4.0"
               "0kvyrsk9y3pjmlr006wrpafgjc7qmf724v1970hd2wycxzmssfi0"))
...
(define rust-hotwatch-0.5.0
  (crate-source "hotwatch" "0.5.0"
               "0ml7cr60cxp3m9aijlj47i683iaprjh5ayf3b3mr4g0nb68j2h4i"))
...
(define rust-new-mime-guess-4.0.4
  (crate-source "new_mime_guess" "4.0.4"
               "1x7gk46ymrkkxdyig84563xzfqll6wfayxlkf05yjlwxanrxz8h2"))
...
(define rust-notify-debouncer-full-0.1.0
  (crate-source "notify-debouncer-full" "0.1.0"
...
(define rust-tikv-jemalloc-sys-0.7.1+5.3.1-0-g81034ce1f1373e37dc865038e1bc8eeecf559ce8
  (crate-source "tikv-jemalloc-sys" "0.7.1+5.3.1-0-g81034ce1f1373e37dc865038e1bc8eeecf559ce8"
...
(define rust-zerocopy-0.8.49
  (crate-source "zerocopy" "0.8.49"
               "02y6zhpdphwnkgww2d81iwljh3mrvcphyz9cihm0fgzsi1i3mqxw"))

(define rust-zerocopy-derive-0.8.49
  (crate-source "zerocopy-derive" "0.8.49"
               "07pfsbx9sx6fzmi870vmih0mlk1m4drqx4pzrijspx2494j2bm4g"))
...
;; ---------------------------------------------------------------------------
;; Lookup table — referenced by wpaperd.scm via cargo-inputs
;; ---------------------------------------------------------------------------
...
(define-cargo-inputs lookup-cargo-inputs
  (wpaperd =>
           (list
              ...
              rust-flate2-1.1.9
              rust-flexi-logger-0.31.9
              rust-format-bytes-0.3.0
              rust-format-bytes-macros-0.4.0
              ...
              rust-new-mime-guess-4.0.4
              rust-nix-0.31.3
              rust-no-std-io2-0.9.4
              rust-nom-8.0.0
              rust-noop-proc-macro-0.3.0
              rust-notify-6.1.1
              rust-notify-debouncer-full-0.1.0
              ...
              rust-xml-rs-0.8.28
              rust-y4m-0.8.0
              rust-zerocopy-0.8.49
              rust-zerocopy-derive-0.8.49
              rust-zmij-1.0.21
